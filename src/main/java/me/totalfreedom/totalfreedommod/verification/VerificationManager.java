package me.totalfreedom.totalfreedommod.verification;
...
public class VerificationManager extends FreedomService
{
    ...
    @EventHandler(priority = EventPriority.HIGHEST) // LOWEST == execute first, sorry Prozza, I'm setting it to HIGHEST
    public void onPlayerChat(AsyncPlayerChatEvent event)
    {
        ...
        if (stage == VerifyStage.SET_PASSWORD)
        {
            ...
            verify.setPassword(event.getMessage());
            veriMsg(player, "Type 'exit' to cancel");
            veriMsg(player, "Please enter your NEW password:");
            return;
        }
