...
@CommandParameters(description = "Make a region for an OP.", usage = "/<command> <playername> <name>", aliases = "mor,newopregion,defineopregion")
public class Command_makeopregion extends FreedomCommand
{
    ...
    public boolean run(final CommandSender sender, final Player playerSender, final Command cmd, final String commandLabel, final String[] args, final boolean senderIsConsole)
    {
        ...
        {
            msg("WorldGuard is currently not enabled on this server.", ChatColor.RED);
        }
        ...
        RegionManager regions = container.get(BukkitAdapter.adapt(playerSender.getWorld()));
        if (regions == null)
        {
            msg("Error: WorldGuard was unable to load the RegionManager.", ChatColor.RED);
            return true;
        }
