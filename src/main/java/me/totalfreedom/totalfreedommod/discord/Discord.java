...
public class Discord extends FreedomService
{
    ...
    public void startBot()
    {
        ...
        {
            FLog.warning("The Discord verification bot failed to start.");
        }
        catch (NoClassDefFoundError e)
        {
            ...
            new BukkitRunnable()
            {
                ...
                public void run()
                {
                    FLog.warning("The JDA plugin was not found.");
                    FLog.info("TotalFreedomMod will automatically try to download the plugin and restart the server.");
                    try
                    {
    ...
    public File generateBackupCodesFile(String name, List<String> codes)
    {
        ...
        text.append("Below are your backup codes for use on " + ConfigEntry.SERVER_NAME + " in the event you lose access to your Discord account.\n")
